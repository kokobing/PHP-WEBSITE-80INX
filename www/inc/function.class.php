...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//取出指定父目录ID的新闻目录所有二级目录    返回变量数组 引用时需要赋值 再输出
...
//取出区块layoutpic指定id的所有图片信息 指定数据库字段tableField 的值  多条  返回变量数组 引用时需要赋值 再输出
function getlayoutallpic($lid,$tableField){
global	 $objDB;//函数调用 声明全局变量
...
//取出区块layoutpic指定id的所有图片信息值  多条  返回变量数组 引用时需要赋值 再输出
function getalllayoutpicinfo($lid){
global	 $objDB;//函数调用 声明全局变量
$strSQL = "select title,intro,opicname as pic from layoutpic  where id_layout ='".$lid."' order by  id_layoutpic asc" ;
$objDB->Execute($strSQL);
$arrallpicsinfo=$objDB->GetRows();
return $arrallpicsinfo;
}
...
//取出版面管理pagesetpic指定id 指定字段的信息  单条   返回变量数组 引用时需要赋值 再输出
function getpagesetpicinfo($lid,$tableField){
global	 $objDB;//函数调用 声明全局变量
